...
public class RecyclerDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_demo);
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerDemoActivity.this));

        RecyclerDemoAdapter adapter = new RecyclerDemoAdapter(RecyclerDemoActivity.this,imageArray,titleArray,offerArray,descArray);
